package com.framework.view.comps
{
	...
	public class LtLabel extends FeathersControl
	{
		...
		public function LtLabel(width:int = -1, height:int = -1, isHtml:Boolean = false, bold:Boolean = false)
		{
			mText = "";
			mFontSize = 22;
			mColor = _defColor;
		...
		public static function create(text:String = ''):LtLabel
		{
			var sglabel:LtLabel = new LtLabel();
			sglabel.text = text;
			return sglabel;
		}
		
		public function setCoor(x:int, y:int):LtLabel
		{
			this.x = x;
			this.y = y;
			return this;
		...
		public function addStyle(style:String = null):LtLabel
		{
			nameList.add(style ? style : StyleName.LABEL_DEF);
			return this;
		}
		
		public function showAs(parent:DisplayObjectContainer):LtLabel
		{
			return parent.addChild(this) as LtLabel;
		}
