package com.losttemple.utils
{
	...
	public class Scale9BatchUtil
	{
		 ...
		 * @private
		 */
		public static function getScale9Batch(_textures:Scale9Textures, _width:Number, _height:Number, _batch:QuadBatch = null, _offsetX:int = 0, _offsetY:int = 0, alpha:Number = 1):QuadBatch
		{
			if (_batch == null) {
